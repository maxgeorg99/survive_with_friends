...
export const MONSTER_SHADOW_OFFSETS_X: Record<string, number> = {
    ...
    "BossAgnaPhase1": -24,   // Large boss, similar to Björn Phase 1
    "BossAgnaPhase2": -64,   // Large final form, similar to Björn Phase 2
...
export const MONSTER_SHADOW_OFFSETS_Y: Record<string, number> = {
    ...
    "BossAgnaPhase1": -2,   // Large boss, similar to Björn Phase 1
    "BossAgnaPhase2": -74,  // Large final form, similar to Björn Phase 2
...
export const MONSTER_SHADOW_SCALE: Record<string, number> = {
    ...
    "BossEnderPhase1": 2.0,
    "BossEnderPhase2": 6.5,
    "BossAgnaPhase1": 1.9,   // Slightly smaller than Björn Phase 1
    "BossAgnaPhase2": 6.2,   // Slightly smaller than Björn Phase 2
