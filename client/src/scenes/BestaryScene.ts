...
export default class BestaryScene extends Phaser.Scene {    
    ...
    private objectsTab!: HTMLButtonElement;
    ...
    private currentTab: 'common' | 'bosses' | 'objects' = 'common'; // Track active tab
    ...
    private monsterImageMapping: Record<string, string> = {
        ...
        "Bat": 'monster_bat.png',
        "VoidChest": 'treasure_chest.png',
        "Crate": 'structure_crate.png',
        "Tree": 'structure_tree.png',
        "Statue": 'structure_statue.png',
        "BossSimonPhase1": 'final_boss_simon_phase_1.png',
        "BossSimonPhase2": 'final_boss_simon_phase_2.png',
        "BossEnderPhase1": 'final_boss_phase_1.png',
        "BossEnderPhase2": 'final_boss_phase_2.png',
        "BossAgnaPhase1": 'boss_agna_1.png',
        "BossAgnaPhase2": 'boss_agna_2.png',        
    };
    ...
    preload() {
        ...
        this.load.image('final_boss_phase_1', '/assets/final_boss_phase_1.png');
        this.load.image('final_boss_phase_2', '/assets/final_boss_phase_2.png');
    ...
    private createMonstersList() {
        ...
        monstersToShow.forEach(monsterType => {
            ...
            // Add monster name - use different localization key for objects
    ...
    private createMonsterDetailsPanel() {
        ...
        // Add default content
        const defaultMessage = this.currentTab === 'objects' ? 
            localization.getText('ui.bestiary.select_object') || 'Select an object to view details...' :
            localization.getText('ui.bestiary.select_monster') || 'Select a monster to view details...';
    ...
    shutdown() {
        ...
        if (this.objectsTab && this.objectsTab.parentNode) {
            this.objectsTab.remove();
        }
    ...
    private createTabButtons() {
        ...
        const existingObjectsTab = document.getElementById('bestiary-objects-tab');
        if (existingObjectsTab) existingObjectsTab.remove();
        ...
        this.commonMonstersTab.style.padding = '12px 20px';
        ...
        this.commonMonstersTab.style.fontSize = '16px';
        this.commonMonstersTab.style.fontWeight = 'bold';
        this.commonMonstersTab.style.flex = '1'; // Equal width tabs
        this.commonMonstersTab.style.textAlign = 'center';
        
        // Objects tab
        this.objectsTab = document.createElement('button');
        this.objectsTab.id = 'bestiary-objects-tab';
        this.objectsTab.textContent = localization.getText('bestiary.category.objects') || 'Objects';
        this.objectsTab.style.padding = '12px 20px';
        this.objectsTab.style.backgroundColor = '#2c3e50'; // Inactive
        this.objectsTab.style.color = 'white';
        this.objectsTab.style.border = '2px solid #34495e';
        this.objectsTab.style.borderRadius = '5px 5px 0 0';
        this.objectsTab.style.cursor = 'pointer';
        this.objectsTab.style.fontSize = '16px';
        this.objectsTab.style.fontWeight = 'bold';
        this.objectsTab.style.flex = '1'; // Equal width tabs
        this.objectsTab.style.textAlign = 'center';
        ...
        this.bossesTab.style.padding = '12px 20px';
        ...
        this.bossesTab.style.fontSize = '16px';
        this.bossesTab.style.fontWeight = 'bold';
        this.bossesTab.style.flex = '1'; // Equal width tabs
        ...
        this.objectsTab.addEventListener('click', () => {
            if (this.currentTab !== 'objects') {
                this.currentTab = 'objects';
                this.updateTabAppearance();
                this.refreshMonstersList();
                this.phaseToggleButton.style.display = 'none'; // Hide phase toggle for objects
            }
        });
        ...
        tabContainer.appendChild(this.objectsTab);
    ...
    private updateTabAppearance() {
        ...
        this.commonMonstersTab.style.backgroundColor = '#2c3e50';
        this.objectsTab.style.backgroundColor = '#2c3e50';
        this.bossesTab.style.backgroundColor = '#2c3e50';
        
        // Set active tab
        if (this.currentTab === 'common') {
            this.commonMonstersTab.style.backgroundColor = '#3498db';
        } else if (this.currentTab === 'objects') {
            this.objectsTab.style.backgroundColor = '#3498db';
        } else {
            this.bossesTab.style.backgroundColor = '#3498db';
        }
    }
    ...
    private refreshMonstersList() {
        ...
        this.createMonstersList();
        this.createMonsterDetailsPanel(); // Recreate with appropriate default message
        this.positionHTMLElements();
    }
    ...
    private createPhaseToggleButton() {
        ...
        this.phaseToggleButton.style.zIndex = '1000'; // Ensure it's above other elements
        ...
        document.body.appendChild(this.phaseToggleButton); // fallback
    }
    ...
    private toggleBossPhase() {
        ...
        // Type-safe way to find matching monster type
        const newMonsterType = Object.values(MonsterType).find(
            (type): type is MonsterType => 
                typeof type === 'object' && 
                type !== null && 
                'tag' in type && 
                type.tag === newMonsterTypeTag
        );
                ...
                <div style="display: flex; flex-direction: column; gap: 10px;">
                    ...
                    <div style="display: flex; gap: 10px; margin-bottom: 5px;">
                        ...
                        <div style="flex-grow: 1;">
                            <p style="margin: 0; line-height: 1.3; font-size: ${13};">${monsterDescription}</p>
                        </div>
                    </div>
                    ...
                    <div style="background-color: rgba(0, 0, 0, 0.2); border-radius: 4px; padding: 8px; margin-bottom: 5px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
                            <div>
                                <div style="color: #e74c3c; font-weight: bold; font-size: ${12};">HP</div>
                                <div style="font-size: ${12};">${stats.hp}</div>
                            </div>
                            <div>
                                <div style="color: #3498db; font-weight: bold; font-size: ${12};">Speed</div>
                                <div style="font-size: ${12};">${stats.speed}</div>
                            </div>
                            <div>
                                <div style="color: #e67e22; font-weight: bold; font-size: ${12};">Damage</div>
                                <div style="font-size: ${12};">${stats.damage}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="white-space: pre-line; line-height: 1.3; font-size: ${12};">${monsterTips}</div>
                    </div>
                </div>
            `;
        } else {
    ...
    private getMonsterStats(monsterType: string): { hp: number, speed: number, damage: number } {
    ...
    private createBackButton() {
        ...
        if (isMobileDevice()) {
            ...
            this.backButton.style.fontSize = '16';
    ...
    private positionHTMLElements() {
        ...
        if (isMobile) {
            ...
            this.titleText.setFontSize(parseInt('36'));
            this.descriptionText.setFontSize(parseInt('16'));
            ...
            if (tabContainer) {
                ...
                if (this.commonMonstersTab && this.bossesTab) {
                    ...
                    this.commonMonstersTab.style.fontSize = '16';
                    this.bossesTab.style.fontSize = '16';
                }
            }
            ...
            this.phaseToggleButton.style.fontSize = '14';
            ...
            this.phaseToggleButton.style.top = `${height * 0.20 + 50}px`;
        }
