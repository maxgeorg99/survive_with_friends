  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    return __AlgebraicTypeValue.Product({
      elements: [
        { name: "attackId", algebraicType: __AlgebraicTypeValue.U32},
  ...
  serialize(writer: __BinaryWriter, value: AttackData): void {
    __AlgebraicTypeValue.serializeValue(writer, AttackData.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): AttackData {
    return __AlgebraicTypeValue.deserializeValue(reader, AttackData.getTypeScriptAlgebraicType());
  },
